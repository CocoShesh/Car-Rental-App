...
function Hero() {
  return (
    <>
      {/* <section className=" flex items-center text-gray-900 justify-center ml-10 mb-20 max-md:flex-col max-md:w-full max-md:h-auto max-md:items-center max-md:text-center max-md:m-0">
        <section>
